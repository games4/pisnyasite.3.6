...
$result_subjects = mysql_query ("SELECT subject.id, subject.title FROM avtor_sliv_sklad, subject WHERE avtor_sliv_sklad.avtor_sliv = $id AND avtor_sliv_sklad.subject = subject.id",$db);
